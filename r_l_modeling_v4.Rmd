    ...
    !(.save_models & file.exists("./models/field_regressions_models.rds")) )
{
  ...
  field_regressions_summaries_separate <- list("brms"=list("with_r" =list("hdi"=bayestestR::hdi(b_null_wr, ci=0.95),
                                                                          ...
                                                                          "fixef"=fixef(b_null_wr), "ranef"=ranef(b_null_wr),
                                                                          "summary"=capture.output(summary(b_null_wr))),
                                                           "without_r" =list("hdi"=bayestestR::hdi(b_null_nr, ci=0.95),
                                                                             "rope"=bayestestR::rope(b_null_nr, ci=0.95, ci_method="HDI", verbose=FALSE),
                                                                             "fixef"=fixef(b_null_nr), "ranef"=ranef(b_null_nr),
                                                                             "summary"=capture.output(summary(b_null_nr)))));
