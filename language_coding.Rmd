...
```{r}
# languages_data <- languages_data %>%
#     dplyr::mutate(glottocode = ifelse(Languages=="serbian","GLOTTOCODE",glottocode))
```
...
```{r}
# languages_data <- languages_data %>%
#     dplyr::mutate(r_l_distinction = ifelse(Languages=="serbian",10,r_l_distinction))
# 
# languages_data <- languages_data %>%
#     dplyr::mutate(trill_real = ifelse(Languages=="serbian",10,trill_real))
# 
# languages_data <- languages_data %>%
#     dplyr::mutate(trill_occ = ifelse(Languages=="serbian",10,trill_occ))
```
...
```{r}
# languages_data <- languages_data %>%
#     dplyr::mutate(glottocode = ifelse(Languages=="silesian","GLOTTOCODE",glottocode))
```
...
```{r}
# languages_data <- languages_data %>%
#     dplyr::mutate(r_l_distinction = ifelse(Languages=="silesian",10,r_l_distinction))
# 
# languages_data <- languages_data %>%
#     dplyr::mutate(trill_real = ifelse(Languages=="silesian",10,trill_real))
# 
# languages_data <- languages_data %>%
#     dplyr::mutate(trill_occ = ifelse(Languages=="silesian",10,trill_occ))
```
...
```{r}
# languages_data <- languages_data %>%
#     dplyr::mutate(glottocode = ifelse(Languages=="sotho","GLOTTOCODE",glottocode))
```
...
```{r}
# languages_data <- languages_data %>%
#     dplyr::mutate(r_l_distinction = ifelse(Languages=="sotho",10,r_l_distinction))
# 
# languages_data <- languages_data %>%
#     dplyr::mutate(trill_real = ifelse(Languages=="sotho",10,trill_real))
# 
# languages_data <- languages_data %>%
#     dplyr::mutate(trill_occ = ifelse(Languages=="sotho",10,trill_occ))
```
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(glottocode = ifelse(Languages=="swahili","GLOTTOCODE",glottocode))
```
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(r_l_distinction = ifelse(Languages=="swahili",10,r_l_distinction))

languages_data <- languages_data %>%
    dplyr::mutate(trill_real = ifelse(Languages=="swahili",10,trill_real))

languages_data <- languages_data %>%
    dplyr::mutate(trill_occ = ifelse(Languages=="swahili",10,trill_occ))
```
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(glottocode = ifelse(Languages=="swazi","GLOTTOCODE",glottocode))
```
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(r_l_distinction = ifelse(Languages=="swazi",10,r_l_distinction))

languages_data <- languages_data %>%
    dplyr::mutate(trill_real = ifelse(Languages=="swazi",10,trill_real))

languages_data <- languages_data %>%
    dplyr::mutate(trill_occ = ifelse(Languages=="swazi",10,trill_occ))
```
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(r_l_distinction = ifelse(Languages=="swedish",10,r_l_distinction))

languages_data <- languages_data %>%
    dplyr::mutate(trill_real = ifelse(Languages=="swedish",10,trill_real))

languages_data <- languages_data %>%
    dplyr::mutate(trill_occ = ifelse(Languages=="swedish",10,trill_occ))
```
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(glottocode = ifelse(Languages=="swissgerman","GLOTTOCODE",glottocode))
```
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(r_l_distinction = ifelse(Languages=="swissgerman",10,r_l_distinction))

languages_data <- languages_data %>%
    dplyr::mutate(trill_real = ifelse(Languages=="swissgerman",10,trill_real))

languages_data <- languages_data %>%
    dplyr::mutate(trill_occ = ifelse(Languages=="swissgerman",10,trill_occ))
```
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(glottocode = ifelse(Languages=="tamil","GLOTTOCODE",glottocode))
```
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(r_l_distinction = ifelse(Languages=="tamil",10,r_l_distinction))

languages_data <- languages_data %>%
    dplyr::mutate(trill_real = ifelse(Languages=="tamil",10,trill_real))

languages_data <- languages_data %>%
    dplyr::mutate(trill_occ = ifelse(Languages=="tamil",10,trill_occ))
```
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(glottocode = ifelse(Languages=="thai","GLOTTOCODE",glottocode))
```
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(r_l_distinction = ifelse(Languages=="thai",10,r_l_distinction))

languages_data <- languages_data %>%
    dplyr::mutate(trill_real = ifelse(Languages=="thai",10,trill_real))

languages_data <- languages_data %>%
    dplyr::mutate(trill_occ = ifelse(Languages=="thai",10,trill_occ))
```
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(glottocode = ifelse(Languages=="turkish","GLOTTOCODE",glottocode))
```
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(r_l_distinction = ifelse(Languages=="turkish",10,r_l_distinction))

languages_data <- languages_data %>%
    dplyr::mutate(trill_real = ifelse(Languages=="turkish",10,trill_real))

languages_data <- languages_data %>%
    dplyr::mutate(trill_occ = ifelse(Languages=="turkish",10,trill_occ))
```
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(glottocode = ifelse(Languages=="ukrainian","GLOTTOCODE",glottocode))
```
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(r_l_distinction = ifelse(Languages=="ukrainian",10,r_l_distinction))

languages_data <- languages_data %>%
    dplyr::mutate(trill_real = ifelse(Languages=="ukrainian",10,trill_real))

languages_data <- languages_data %>%
    dplyr::mutate(trill_occ = ifelse(Languages=="ukrainian",10,trill_occ))
```
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(glottocode = ifelse(Languages=="vietnamese","GLOTTOCODE",glottocode))
```
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(r_l_distinction = ifelse(Languages=="vietnamese",10,r_l_distinction))

languages_data <- languages_data %>%
    dplyr::mutate(trill_real = ifelse(Languages=="vietnamese",10,trill_real))

languages_data <- languages_data %>%
    dplyr::mutate(trill_occ = ifelse(Languages=="vietnamese",10,trill_occ))
```
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(glottocode = ifelse(Languages=="wolof","GLOTTOCODE",glottocode))
```
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(glottocode = ifelse(Languages=="xhosa","GLOTTOCODE",glottocode))
```
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(glottocode = ifelse(Languages=="zulu","GLOTTOCODE",glottocode))
```
