---
title: "R/L across languages: coding 'r'"
author: "Rémi Anselme (& Aleksandra Ćwiek (& Dan Dediu))"
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(glottocode = ifelse(Languages=="norwegian","norw1259",glottocode))
```
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(glottocode = ifelse(Languages=="swedish","swed1254",glottocode))
```
...
https://www.quora.com/Do-you-roll-the-%E2%80%9CR%E2%80%9D-in-the-Turkish-language

  - Do all Turkish speakers roll their R, for example in the word yürü, or is this regional or by personality? — Related (https://www.quora.com/Do-all-Turkish-speakers-roll-their-R-for-example-in-the-word-y%C3%BCr%C3%BC-or-is-this-regional-or-by-personality)
Profile photo for Noyan Aydin
Noyan Aydin
Being Turk and proud at the same time needs self-improvement2y

No, it is for emphasizing and expressing anger, dismissal, and contempt.

You say “yürrrrüüü” to someone you agitated you and you made him ashamed somehow. When he had no answer and speechless, you dismiss him from your face. There is a common phrase for that case “yürü anca gidersin” with rolling r in yürü.

Profile photo for Lee Vardar
Lee Vardar
Lived in Turkey
 · 6y
Do you roll the “R” in the Turkish language? (https://www.quora.com/Do-you-roll-the-%E2%80%9CR%E2%80%9D-in-the-Turkish-language)

Typically no. Unless you're really trying to perhaps emphasise “Turkish.”

Examples: “It's Turrrkish, not xyz!” I'm “Turrrkish, not xyz!” “I'm from Turrrkey I tell you!”
Author has 522 answers and 369.1K answer views
...
languages_data <- languages_data %>%
    dplyr::mutate(trill_occ = ifelse(Languages=="turkish",1,trill_occ))
#Je pense que le trill doit être posssible -> à vérifier ; mais je ne trouve pas d'autres sources que Quora ; je pense que j'ai un mémoire d'un étudiant en Turc mais aucune idée d'où il est sur mon ordi
```
...
Manessy, Gabriel and Sauvageot, Serge. 1963. Notes Preliminaires to Wolof Et Serer: Etudes De Phonetique Et De Grammaire Descriptive. Dakar: Universite de Dakar. [pas trouvé]
Ward, Ida C. 1963. A Short Phonetic Study of Wolof (Jolof) as Spoken in the Gambia and in Senegal. In Manessy, Gabriel and Sauvageot, Serge (eds.), Wolof et sér`er; études de phonétique et de grammaire descriptive, 57–63. Dakar: Université de Dakar, Faculté des lettres et sciences humaines. [pas cherché]
Sauvageot, Serge. 1965. Description synchronique d'un dialecte wolof: le parler du dyolof. (Mémoires de l'Institut Fondamental d'Afrique Noire, 73.) Dakar: Institut Franccais de l'Afrique Noire.
  ...
  - Page 18 :1-19. Le phonème r.
L'identité phonologique de ce phonème ressort des rapprochements suivants
r/l: cf. ci-dessus sous 1-18.
r/x: ras « mettre en plis, serrer II - xas « faire des reproches, injurier ll; l'el' « (le)
dîner; dîner» - xex « (la) guerre; faire la guerre, combattre ".
Le phonème l'est vibrant.
Il est réalisé comme une vibrante sonore à battement unique. Sa vibrance est
pertinente. Il connaît à la finale absolue une réalisation sourde fricative.
Il apparaît dans toutes les positions de monème.
...
Hartell, Rhonda L. (ed.) 1993. Alphabets des langues africaines. UNESCO and Société Internationale de Linguistique.
  ...
  - Page 252 : /ɾ/ r
               ...
               => à partir de :
               Décret n°71-566 du 21 mai 1971 relatif à la trasncription des langues nationales du Sénégal. N° Spécial du Journal Oficiel de la République du Sénégal, 21 juin 1971, Rufisque, Imprimerie nationale; et Transcription des langues nationales, Rufisque, Imprimerie nationale - D.L. 3038 - avril 1972
               Décret n°85-1232 du 20 novembre 1985 relatif à l'orthographe et à la séparation des mots en wolof. Journal Officiel de la République du Sénégal du 23 novembre 1985, Rufisque, Imprimerie nationale.
...
https://en.wikipedia.org/wiki/Wolof_language
  ...
  [20] Pape Amadou Gaye, 1980. Practical Cours in / Cours Practique en Wolof: An Audio–Aural Approach.
          - Page xiv : r reer = diner/diner radio the 'r' is like the Spanish 'r'
          - Page xv : Toutes les consonnes sauf q, s et x se redoublent aussi bien exposition mediane que finale et dans ce cas indique un sens completement diffirea.
...
Diouf, Jean-Léopold. 2009. Grammaire du wolof contemporain. Revue et complétée edn. Paris: L'Harmattan. 223pp.

  - Page 13 : Les consonnes sont : [...] r [...] 
  - Page 15 : Sourdes versus sonores
              Les consonnes sourdes sont celles qu'on produit par la vibration de l'air contenu dans le chenal buccal. Ce sont :
              [...] r [...]
              
              Contstrictives
              Les consonnes constrictives (ou fricatives) sont celles qui se produisent avec un resserrement du passage de l'air à un point donnée du chenal bucal. Ce sont :
              [...] r [...]
              Simples, géminées, ou prénasales
              Les consonnes simples (ou brèves) sont:
              [...] r [...]
  - Page 17 : c o n s non latérales roulée r
  
Autres sources : 

565s -> 569s -> pronunciation of the /r/ -> trills
https://www.youtube.com/watch?v=qvtMkkzUR1U

```{r}
languages_data <- languages_data %>%
    dplyr::mutate(r_l_distinction = ifelse(Languages=="wolof",1,r_l_distinction))

languages_data <- languages_data %>%
    dplyr::mutate(trill_real = ifelse(Languages=="wolof",0,trill_real))

languages_data <- languages_data %>%
    dplyr::mutate(trill_occ = ifelse(Languages=="wolof",1,trill_occ))
```
...
Gowlett, Derek. 2003. Zone S. In Nurse, Derek and Philippson, Gérard (eds.), The Bantu Languages, 609–638. Routledge.
  ...
  - Page 615 : Pas de r pour le Xhosa (mais on a un breathy-voiced trill pour le Copi)
...
VanderStouwe, C. (2013). A phonetic and phonological report on the Xhosa language. Unpublished final project. Retrieved, 8.

  - Page 8 : Trill r*
            * [r] is found only in borrowings, and is not native to the Xhosa language. Example: [iɔrenʤi] 'orange'
...
Niesler, T., Louw, P., & Roux, J. (2005). Phonetic analysis of afrikaans, english, xhosa and zulu using South African speech databases. Southern African linguistics and applied language studies, 23(4), 459-474.
  ...
  - Page 461 : Trills and flapsTwo trills and one flap were found in our data.The alveolar trill [r] was transcribed in alldatabases, although this sound occurs only inphonologised loanwords or borrowed words inEnglish, Xhosa and Zulu. The uvular trill [R]occurs only in Afrikaans and Xhosa. In the Afri-kaans data, the alveolar flap [|] is only foundwhere assimilation occurs, for example in thewords vat dit (‘take it’), while in Xhosa and Zulu itis only found in borrowed words such as quarter.

Andrason, A. (2020). Ideophones as linguistic" rebels": the extra-systematicity of ideophones in Xhosa (part 1).

  - Page 134 : Ideophones also exhibit the trill consonant [r], which, at least etymologically, is foreign to the sound system of Xhosa and other Nguni languages.65 Only recently has [r] been introduced into the Xhosa phonetic inventory due to contact with English and, albeit to a lesser extent, Afrikaans.66 In ideophones, however, r [r] seems to have been original and etymological, as illustrated by r-r, rru, re, rre, r-re ‘be mad; go fast’, rru-u ‘go steadily’, or fórnyúphù ‘worry someone’.67
  
  65 Cf. LOUW, J.A. The Influence of Khoi on the Xhosa Language. In Limi, 1974, Vol. 2(2), pp. 45–62; LOUW, J.A. The Influence of Khoi on Xhosa Morphology. In DE KLERK, W., PONELIS, F.A. (eds.). Gedenkbundel H. J. J. M. van der Merwe, 87–95; MSIMANG, C.T., POULOS, G. The ideophone in Zulu: A Re-examination of Conceptual and Descriptive Notions. In VOELTZ, E., KILIAN-HATZ, C. (eds.). Ideophones, p. 246.
66 Therefore, original loanwords containing r used to exhibit l or d when introduced and adapted to Xhosa. See LOUW, J.A. The Influence of Khoi on the Xhosa Language. In Limi, 1974, Vol. 2(2), pp. 45–62; LOUW, J.A. The Influence of Khoi on Xhosa Morphology. In DE KLERK, W., PONELIS, F.A. (eds.). Gedenkbundel H. J. J. M. van der Merwe, 87–95; ANDRASON, A. The “Exotic” Nature of Ideophones – From Khoekhoe to Xhosa. In Stellenbosch Papers in Linguistics, 2017, Vol. 48, pp. 139–150. 
67 Similarly, [r] is found in ideophones in Zulu, even though it is “foreign” to the sound system of that language. See CHILDS, T. Where Have All the Ideophones Gone? The Death of a Word Category in Zulu. In Toronto Working Papers in Linguistics, 1996, Vol. 15, p. 94; MSIMANG, C.T., POULOS, G. The ideophone in Zulu: A Re-examination of Conceptual and Descriptive Notions. In VOELTZ, E., KILIAN-HATZ, C. (eds.). Ideophones, p. 246; see also FIVAZ, D. Some Aspects of the Ideophone in Zulu, pp. 8, 9, 11, 22. Zulu ideophones contain other rare sounds, e.g. [ts], which is also the case of Xhosa (see tsé ‘be straight’ and tsákú ‘go and return quickly’). See MSIMANG, C.T., POULOS, G. The ideophone in Zulu: A Re-examination of Conceptual and Descriptive Notions. In VOELTZ, E., KILIAN-HATZ, C. (eds.). Ideophones, p. 246.

```{r}
languages_data <- languages_data %>%
    dplyr::mutate(r_l_distinction = ifelse(Languages=="xhosa",0,r_l_distinction))

languages_data <- languages_data %>%
    dplyr::mutate(trill_real = ifelse(Languages=="xhosa",0,trill_real))

languages_data <- languages_data %>%
    dplyr::mutate(trill_occ = ifelse(Languages=="xhosa",1,trill_occ))
```
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(glottocode = ifelse(Languages=="zhuang","daic1237",glottocode))
```

Phoible :   
J'ai pris des inventaires aléatoirement sur la base de ce que je trouvais sur Glottolog pour daic1237.

https://phoible.org/inventories/view/502

  - pas de r ; on a un l et un ʐ
  
https://en.wikipedia.org/wiki/N%C3%B9ng_language_(Tai)

https://phoible.org/inventories/view/2361

  - r pas d'allophones ; contrast r/l
  
Gedney, William J and Hudak, Thomas J. 1993. William J. Gedney's The Saek language: glossary, texts, and translations. University of Michigan Center for.
https://en.wikipedia.org/wiki/Saek_language

https://phoible.org/languages/bouy1240
2 inventaires :

  - SPA r allophone r ; contrast r/l
  - UPSID R̪|R pas d'allophone ; contrast R̪|R/	l̪|l
Gedney, William J. 1965. Yay, a Northern Tai Language in North Vietnam. Lingua 14. 180–193.
https://en.wikipedia.org/wiki/Bouyei_language
  - Continuant voiced r /z/~[ð]
...
Wei, Qingwen 韦庆稳; Qin, Guosheng 覃国生 (1980). Zhuàngyǔ jiǎnzhì 壮语简志 [Concise Grammar of Zhuang]. Zhongguo shaoshu minzu yuyan jianzhi congshu (in Chinese). Beijing: Minzu chubanshe. [pas cherché]
Zhang, Junru 张均如; Liang, Min 梁敏; Ouyang, Jueya 欧阳觉亚; Zheng, Yiqing 郑贻青; Li, Xulian 李旭练; Xie, Jianyou 谢建猷 (1999). Zhuàngyǔ fāngyán yánjiū 壮语方言研究 [A Study of Zhuang Dialects] (in Chinese). Chengdu: Sichuan minzu chubanshe. ISBN 7-5409-2293-1. [pas cherché]
...
Diller, A., Edmondson, J., & Luo, Y. (2004). The Tai-Kadai Languages. Routledge.

  - Page 321 : As mentioned in §9.1.3, substantial differences exist in the phonological systems of Northern and Southern Zhuang. In addition to the absence of aspirated stops in Northern Zhuang, and their presence in Southern Zhuang, Northern Zhuang has a group of /r/ sounds, represented as ɣ, r, ð, j and l according to dialects. These correspond to an array of forms in Southern Zhuang. The following examples illustrate this.
TABLE 9.2-1: NORTHERN ZHUANG /r/ AND THEIR SOUTHERN ZHUANG COUNTERPARTS
[table]
  - Page 323 : 9.2.1. Fengshan Zhuang phonology
                9.2.1.1. Consonants
                Table 9.2.1.1-1 lists the nineteen segmental consonant phonemes in Fengshan Zhuang.
                TABLE 9.2.1.1-1: FENGSHAN ZHUANG CONSONANTS
                
                => Pas de mention de r ; mais on a un j et un l
                
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(r_l_distinction = ifelse(Languages=="zhuang",0,r_l_distinction))

languages_data <- languages_data %>%
    dplyr::mutate(trill_real = ifelse(Languages=="zhuang",0,trill_real))

languages_data <- languages_data %>%
    dplyr::mutate(trill_occ = ifelse(Languages=="zhuang",1,trill_occ))
#Je met 1 mais c'est un hypothèse sur la base que c'est une langue tai-kadai et qu'il pourrait y avoir des dialectes qui ont maintenu la rhotique comme un trill ou un tap ; mais si besoin on peut changer en 0 ; je ne sais pas d'où vient l'influence de la graphie du r
```
...
2 inventaires :
  ...
  - SPA pas de r ; on a un l
  - UPSID r (marginal)  ; on a un l donc contrast r/l

Doke, Clement M. 1961. Textbook of Zulu Grammar. Cape Town: Longmans. (6th edition (1st edition 1927)). [pas trouvé]
Doke, Clement M. 1926. The Phonetics of the Zulu Language. (Bantu Studies.) Johannesburg: Wiwatersrand University Press. [pas trouvé]
Rycroft, David K. and Ngcobe, A. B. 1979. Say It in Zulu. London: School of Oriental and African Studies. [pas trouvé]
...
Poulos, G., & Bosch, S. E. (1997). Zulu (Languages of the World/Materials, 50). München: Lincom Europa.

  - Page 50 : Continuant Trill r
  
George Poulos, Christian T. Msimang - A Linguistic Analysis of Zulu (1998, Via Africa) 

  - Page 474 : The trill
  There is also only one trill in Zulu. This consonant, which is represented by r in the orthography, is produced by the tip of the tongue tapping more than once against the alveolar ridge (two or three taps in succession appear to be the norma) This sound is found only in ideophones e.g. ndri (of flying).
  Once again, there is no real build-up of pressure behing the succesive closures which occur, and in this respect, the trill, differs from the stop consonants described earlier.

Andrason, A. (2020). Ideophones as linguistic" rebels": the extra-systematicity of ideophones in Xhosa (part 1).
  Page 134 : 67 Similarly, [r] is found in ideophones in Zulu, even though it is “foreign” to the sound system of that language. See CHILDS, T. Where Have All the Ideophones Gone? The Death of a Word Category in Zulu. In Toronto Working Papers in Linguistics, 1996, Vol. 15, p. 94; MSIMANG, C.T., POULOS, G. The ideophone in Zulu: A Re-examination of Conceptual and Descriptive Notions. In VOELTZ, E., KILIAN-HATZ, C. (eds.). Ideophones, p. 246; see also FIVAZ, D. Some Aspects of the Ideophone in Zulu, pp. 8, 9, 11, 22. Zulu ideophones contain other rare sounds, e.g. [ts], which is also the case of Xhosa (see tsé ‘be straight’ and tsákú ‘go and return quickly’). See MSIMANG, C.T., POULOS, G. The ideophone in Zulu: A Re-examination of Conceptual and Descriptive Notions. In VOELTZ, E., KILIAN-HATZ, C. (eds.). Ideophones, p. 246.

```{r}
languages_data <- languages_data %>%
    dplyr::mutate(r_l_distinction = ifelse(Languages=="zulu",0,r_l_distinction))

languages_data <- languages_data %>%
    dplyr::mutate(trill_real = ifelse(Languages=="zulu",0,trill_real))

languages_data <- languages_data %>%
    dplyr::mutate(trill_occ = ifelse(Languages=="zulu",1,trill_occ))
```

# Additions by Ola for field data

I will try to do justice to Rémi's excellent work.
...
```{r}
# Adding new rows to languages_data
languages_data <- languages_data %>%
  bind_rows(data.frame(Languages = c("daakie", "palikur", "berber", "bislama", "BSL", 
                   "cantonese", "punjabi", "urdu", "welsh", "yoruba")))
```
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(glottocode = ifelse(Languages=="daakie","	port1286",glottocode))
```

Sometimes known as Port Vato language.

Phoible: NA

Wikipedia:
https://en.wikipedia.org/wiki/Port_Vato_language

Glottolog:
https://glottolog.org/resource/languoid/id/port1286

Other sources:
Krifka, Manfred. 2022. Daakie DoReCo dataset. In Seifart, Frank, Ludger Paschen and Matthew Stave (eds.). Language Documentation Reference Corpus (DoReCo) 1.2. Berlin & Lyon: Leibniz-Zentrum Allgemeine Sprachwissenschaft & laboratoire Dynamique Du Langage (UMR5596, CNRS & Université Lyon 2). https://doreco.huma-num.fr/languages/port1286 (Accessed on 03/01/2024). DOI:10.34847/nkl.efeav5l9 

Listening to doreco_port1286_08-24-11_Andri.wav from the DoReCo corpus at least a tap /r/ can be recognized. The speaker also produces /l/. We can assume having a distinction. The trill, or at least a tap occurs in the language. The question is, whether real trill is used as the main variant.

While /r/ is infrequent, it is used used in the tongue tip tap/trill form as main realization (the recording above, 77 sec "soró", 85 sec "weren" and so on)

```{r}
languages_data <- languages_data %>%
    dplyr::mutate(r_l_distinction = ifelse(Languages=="daakie",1,r_l_distinction))

languages_data <- languages_data %>%
    dplyr::mutate(trill_real = ifelse(Languages=="daakie",1,trill_real))

languages_data <- languages_data %>%
    dplyr::mutate(trill_occ = ifelse(Languages=="daakie",1,trill_occ))
```
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(glottocode = ifelse(Languages=="palikur","pali1279",glottocode))
```


Phoible: 
https://phoible.org/inventories/view/1826 

  - Neither /r/ nor /l/ as segments

Wikipedia:
https://en.wikipedia.org/wiki/Palik%C3%BAr_language

  - Neither /r/ nor /l/ as segments

Glottolog:
https://glottolog.org/resource/languoid/id/pali1279

Other sources:

There is no distinction and, thus, alveolar trill cannot be the main phoneme. I am uncertain if this sound ever occurs, but because of the lack of distinction, we will set it to 0 for now.

```{r}
languages_data <- languages_data %>%
    dplyr::mutate(r_l_distinction = ifelse(Languages=="palikur",0,r_l_distinction))

languages_data <- languages_data %>%
    dplyr::mutate(trill_real = ifelse(Languages=="palikur",0,trill_real))

languages_data <- languages_data %>%
    dplyr::mutate(trill_occ = ifelse(Languages=="palikur",0,trill_occ))
```
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(glottocode = ifelse(Languages=="berber","tach1250",glottocode))
```
...
https://phoible.org/inventories/view/123
  ...
  - Both /r/ and /l/ as segments
  - Specifically, /r/ is the alveolar trill

Wikipedia:
https://en.wikipedia.org/wiki/Shilha_language

Glottolog:
https://glottolog.org/resource/languoid/id/tach1250
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(r_l_distinction = ifelse(Languages=="berber",1,r_l_distinction))

languages_data <- languages_data %>%
    dplyr::mutate(trill_real = ifelse(Languages=="berber",1,trill_real))

languages_data <- languages_data %>%
    dplyr::mutate(trill_occ = ifelse(Languages=="berber",1,trill_occ))
```
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(glottocode = ifelse(Languages=="bislama","bisl1239",glottocode))
```
...
https://en.wikipedia.org/wiki/Bislama
  ...
  - No phonology available
  - More than 95% of Bislama words are of English origin, whilst the remainder comprises a few dozen words from French as well as some specific vocabulary inherited from various languages of Vanuatu—although these are essentially limited to flora and fauna terminology.[4] 

Glottolog:
https://glottolog.org/resource/languoid/id/pali1279

Other sources:
WALS: https://wals.info/languoid/lect/wals_code_bsm

Tryon, D. T. (1987). Bislama: An introduction to the national language of Vanuatu. The Australian National University.
https://openresearch-repository.anu.edu.au/bitstream/1885/263015/1/PL-D72.pdf, 

  - On page 4, notes /r/ and /l/ as separate phonemes, and says "The sounds which distinguish meaning in Bislama, called phonemes in technical terms, are not the same as in English"
  - On page 8, "/r/ is always realised as r (a voiced alveolar trill/a voiceless alveolar trill or a voiced alveolar flap)."


```{r}
languages_data <- languages_data %>%
    dplyr::mutate(r_l_distinction = ifelse(Languages=="bislama",1,r_l_distinction))

languages_data <- languages_data %>%
    dplyr::mutate(trill_real = ifelse(Languages=="bislama",1,trill_real))

languages_data <- languages_data %>%
    dplyr::mutate(trill_occ = ifelse(Languages=="bislama",1,trill_occ))
```
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(glottocode = ifelse(Languages=="BSL","brit1235",glottocode))
```
...
Wikipedia:
https://de.wikipedia.org/wiki/British_Sign_Language
...
```{r}
languages_data <- languages_data %>% 
     dplyr::mutate(r_l_distinction = ifelse(Languages=="BSL",as.integer(NA),r_l_distinction))

languages_data <- languages_data %>%
    dplyr::mutate(trill_real = ifelse(Languages=="BSL",as.integer(NA),trill_real))

languages_data <- languages_data %>%
    dplyr::mutate(trill_occ = ifelse(Languages=="BSL",as.integer(NA),trill_occ))
```
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(glottocode = ifelse(Languages=="cantonese","cant1236",glottocode))
```


Phoible: 
https://phoible.org/inventories/view/19

  - /l/ as a phoneme, but no /r/ (also not as allophone)

Wikipedia:
https://en.wikipedia.org/wiki/Cantonese_phonology

  - /l/ as a phoneme, but no /r/
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(r_l_distinction = ifelse(Languages=="cantonese",0,r_l_distinction))

languages_data <- languages_data %>%
    dplyr::mutate(trill_real = ifelse(Languages=="cantonese",0,trill_real))

languages_data <- languages_data %>%
    dplyr::mutate(trill_occ = ifelse(Languages=="cantonese",0,trill_occ))
```
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(glottocode = ifelse(Languages=="punjabi","panj1256",glottocode))
```


Phoible: 
RA 1780 https://phoible.org/inventories/view/1780

  - Both /r/ and /l/ as segments
  
SPA 175 https://phoible.org/inventories/view/175
...
Glottolog:
https://glottolog.org/resource/languoid/id/east2727
There is Eastern and western, but based on the geolocation on Phoible, eastern suited better.
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(r_l_distinction = ifelse(Languages=="punjabi",1,r_l_distinction))

languages_data <- languages_data %>%
    dplyr::mutate(trill_real = ifelse(Languages=="punjabi",1,trill_real))

languages_data <- languages_data %>%
    dplyr::mutate(trill_occ = ifelse(Languages=="punjabi",1,trill_occ))
```
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(glottocode = ifelse(Languages=="urdu","urdu1245",glottocode))
```


Phoible: 
EA 2466 https://phoible.org/inventories/view/2466

  - /r/ but no /l/
  
RA 1797 https://phoible.org/inventories/view/1797
...
Glottolog:
https://glottolog.org/resource/languoid/id/urdu1245

Other sources:
https://www.cle.org.pk/Downloads/ling_resources/phoneticinventory/UrduPhoneticInventory.pdf

  - notes both /l/ and /r/ (alveolar trill)

Saleem, A. M., Kabir, H. A. S. A. N., Riaz, M. K., Rafique, M. M., Khalid, N. A. U. M. A. N., & Shahid, S. R. (2002). Urdu consonantal and vocalic sounds. CRULP Annual Student Report. https://www.cle.org.pk/Publication/Crulp_report/CR02_01E.pdf

  - reports [r] as a palatal voiced trill
  
Just to be safe, I will adopt the view that there is a contrast and alveolar trill occurs, and it is the real form.

```{r}
languages_data <- languages_data %>%
    dplyr::mutate(r_l_distinction = ifelse(Languages=="urdu",1,r_l_distinction))

languages_data <- languages_data %>%
    dplyr::mutate(trill_real = ifelse(Languages=="urdu",1,trill_real))

languages_data <- languages_data %>%
    dplyr::mutate(trill_occ = ifelse(Languages=="urdu",1,trill_occ))
```
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(glottocode = ifelse(Languages=="welsh","wels1247",glottocode))
```
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(r_l_distinction = ifelse(Languages=="welsh",1,r_l_distinction))

languages_data <- languages_data %>%
    dplyr::mutate(trill_real = ifelse(Languages=="welsh",1,trill_real))

languages_data <- languages_data %>%
    dplyr::mutate(trill_occ = ifelse(Languages=="welsh",1,trill_occ))
```
...
```{r}
languages_data <- languages_data %>%
    dplyr::mutate(glottocode = ifelse(Languages=="yoruba","yoru1245",glottocode))
```


Phoible: 
UPSID 636 https://phoible.org/inventories/view/636

  - /l/ and only tap /r/
  
AA 847 https://phoible.org/inventories/view/847

  - /l/ and /r/ (alveolar trill)
  
AA 848 https://phoible.org/inventories/view/848
...
I will assume a form of trill but not as main occurence due to mixed reports about the tap

```{r}
languages_data <- languages_data %>%
    dplyr::mutate(r_l_distinction = ifelse(Languages=="yoruba",1,r_l_distinction))

languages_data <- languages_data %>%
    dplyr::mutate(trill_real = ifelse(Languages=="yoruba",0,trill_real))

languages_data <- languages_data %>%
    dplyr::mutate(trill_occ = ifelse(Languages=="yoruba",1,trill_occ))
```

# Save output

```{r}
readr::write_csv(languages, paste0(data,
                            "languages.csv"))
readr::write_csv(languages_data, paste0(data,
                            "languages_data.csv"))
```
